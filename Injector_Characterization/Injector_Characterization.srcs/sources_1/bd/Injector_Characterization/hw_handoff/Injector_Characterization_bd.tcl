...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_S00_FIFO_DEPTH {32768} \
   CONFIG.C_S00_FIFO_FULL_THRESH {32765} \
 ] $AXI_Injector_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins AXI_Injector_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins InterruptGenerator_0/S_AXI_INTR] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net AXI_Injector_0_dout [get_bd_pins AXI_Injector_0/dout] [get_bd_pins util_reduced_logic_0/Op1]
  connect_bd_net -net AXI_Injector_0_empty [get_bd_pins AXI_Injector_0/empty] [get_bd_pins InterruptGenerator_0/interrupt_in]
  connect_bd_net -net AXI_Injector_0_sync_out [get_bd_ports led2] [get_bd_pins AXI_Injector_0/trigger_out]
  connect_bd_net -net InterruptGenerator_0_irq [get_bd_pins InterruptGenerator_0/irq] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXI_Injector_0/rd_clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins AXI_Injector_0/rd_clk_en] [get_bd_pins clk_wiz_0/locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_Injector_0/s00_axi_aclk] [get_bd_pins InterruptGenerator_0/s_axi_intr_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_Injector_0/s00_axi_aresetn] [get_bd_pins InterruptGenerator_0/s_axi_intr_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_ports led1] [get_bd_pins util_reduced_logic_0/Res]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs InterruptGenerator_0/S_AXI_INTR/S_AXI_INTR_reg] SEG_InterruptGenerator_0_S_AXI_INTR_reg
