...
HD_PWD='D:/depot/Projects/ETF_2021/Injector_Characterization/Injector_Characterization.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Injector_Characterization_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Injector_Characterization_wrapper.tcl
