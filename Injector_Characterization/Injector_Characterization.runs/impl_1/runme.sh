...
HD_PWD='D:/depot/Projects/ETF_2021/Injector_Characterization/Injector_Characterization.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Injector_Characterization_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Injector_Characterization_wrapper.tcl -notrace
