...
HD_PWD='C:/Users/Robert/xilinx_projects/Injector_Characterization/Injector_Characterization.runs/Injector_Characterization_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Injector_Characterization_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Injector_Characterization_xbar_0.tcl
