...
EAStep vivado -log Injector_Characterization_AXI_Injector_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Injector_Characterization_AXI_Injector_0_1.tcl
