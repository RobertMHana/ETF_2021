...
EAStep vivado -log Injector_Characterization_InterruptGenerator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Injector_Characterization_InterruptGenerator_0_0.tcl
