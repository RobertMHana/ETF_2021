...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = Interrupt_Injector
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = Interrupt_Sampler
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ClockDivider
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = Injector
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = Sampler
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXITrigger
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Trigger
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.2
 PARAMETER HW_INSTANCE = VGASubsection_BRAMController
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = VGASubsection_VGAHorizontal_int
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = VGASubsection_VGAVertical_int
END
