...
--               d:/depot/Projects/ETF_2021/EmbeddedTestFramework/EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ip/EmbeddedTestFramework_clk_wiz_0_0/EmbeddedTestFramework_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : EmbeddedTestFramework_clk_wiz_0_0
...
entity EmbeddedTestFramework_clk_wiz_0_0_EmbeddedTestFramework_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of EmbeddedTestFramework_clk_wiz_0_0_EmbeddedTestFramework_clk_wiz_0_0_clk_wiz : entity is "EmbeddedTestFramework_clk_wiz_0_0_clk_wiz";
end EmbeddedTestFramework_clk_wiz_0_0_EmbeddedTestFramework_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of EmbeddedTestFramework_clk_wiz_0_0_EmbeddedTestFramework_clk_wiz_0_0_clk_wiz is
  signal clk_in1_EmbeddedTestFramework_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_EmbeddedTestFramework_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_EmbeddedTestFramework_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => clk_out1_EmbeddedTestFramework_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity EmbeddedTestFramework_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of EmbeddedTestFramework_clk_wiz_0_0 : entity is true;
end EmbeddedTestFramework_clk_wiz_0_0;

architecture STRUCTURE of EmbeddedTestFramework_clk_wiz_0_0 is
begin
inst: entity work.EmbeddedTestFramework_clk_wiz_0_0_EmbeddedTestFramework_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
