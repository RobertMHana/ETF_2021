...
ISEStep( "vivado",
         "-log EmbeddedTestFramework_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_util_vector_logic_0_0.tcl" );
