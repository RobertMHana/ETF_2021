...
HD_PWD='D:/depot/Projects/ETF_2021/EmbeddedTestFramework/EmbeddedTestFramework.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EmbeddedTestFramework_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_wrapper.tcl
