...
ISEStep( "vivado",
         "-log EmbeddedTestFramework_GatedClockEnable_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_GatedClockEnable_0_0.tcl" );
