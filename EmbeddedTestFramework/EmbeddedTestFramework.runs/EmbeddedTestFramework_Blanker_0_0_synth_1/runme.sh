...
HD_PWD='C:/Users/Robert/xilinx_projects/EmbeddedTestFramework/EmbeddedTestFramework.runs/EmbeddedTestFramework_Blanker_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EmbeddedTestFramework_Blanker_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_Blanker_0_0.tcl
