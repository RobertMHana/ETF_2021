...
ISEStep( "vivado",
         "-log EmbeddedTestFramework_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_axi_bram_ctrl_0_0.tcl" );
