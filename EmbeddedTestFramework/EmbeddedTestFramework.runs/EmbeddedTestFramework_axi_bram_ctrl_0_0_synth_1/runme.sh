...
HD_PWD='D:/depot/Projects/ETF_2021/EmbeddedTestFramework/EmbeddedTestFramework.runs/EmbeddedTestFramework_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EmbeddedTestFramework_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_axi_bram_ctrl_0_0.tcl
