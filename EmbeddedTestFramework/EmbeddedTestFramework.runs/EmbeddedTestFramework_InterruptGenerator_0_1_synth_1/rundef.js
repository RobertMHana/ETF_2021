...
ISEStep( "vivado",
         "-log EmbeddedTestFramework_InterruptGenerator_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_InterruptGenerator_0_1.tcl" );
