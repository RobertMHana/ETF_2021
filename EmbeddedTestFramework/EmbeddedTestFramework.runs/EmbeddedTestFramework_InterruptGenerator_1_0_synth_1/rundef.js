...
ISEStep( "vivado",
         "-log EmbeddedTestFramework_InterruptGenerator_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EmbeddedTestFramework_InterruptGenerator_1_0.tcl" );
