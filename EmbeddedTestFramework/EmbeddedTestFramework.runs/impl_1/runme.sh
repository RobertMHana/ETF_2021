...
HD_PWD='D:/depot/Projects/ETF_2021/EmbeddedTestFramework/EmbeddedTestFramework.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EmbeddedTestFramework_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EmbeddedTestFramework_wrapper.tcl -notrace
