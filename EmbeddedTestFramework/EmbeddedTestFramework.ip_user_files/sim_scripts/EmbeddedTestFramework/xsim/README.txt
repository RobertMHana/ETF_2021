...
#
# Generated by export_simulation on Sun Apr 18 19:21:34 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './EmbeddedTestFramework.sh' script.

./EmbeddedTestFramework.sh -reset_run
...
./EmbeddedTestFramework.sh -noclean_files

For more information on the script, please type './EmbeddedTestFramework.sh -help'.
