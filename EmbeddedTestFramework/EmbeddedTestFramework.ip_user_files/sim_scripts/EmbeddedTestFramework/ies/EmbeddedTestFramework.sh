...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.EmbeddedTestFramework \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/5bb9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/70fd/hdl" \
       +incdir+"$ref_dir/../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/b65a" \
       +incdir+"../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/ec67/hdl" \
       +incdir+"../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/70fd/hdl" \
       +incdir+"../../../../EmbeddedTestFramework.srcs/sources_1/bd/EmbeddedTestFramework/ipshared/b65a" \
