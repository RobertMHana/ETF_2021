...
----------------------------------------------------------------------------------
--Command: generate_target bd_2ef2.bd
--Design : bd_2ef2
...
entity bd_2ef2 is
  ...
  attribute CORE_GENERATION_INFO of bd_2ef2 : entity is "bd_2ef2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2ef2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_2ef2 : entity is "ILA_Interrupt_system_ila_0_0.hwdef";
end bd_2ef2;

architecture STRUCTURE of bd_2ef2 is
  component bd_2ef2_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_2ef2_ila_lib_0;
  component bd_2ef2_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_2ef2_g_inst_0;
  component bd_2ef2_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_2ef2_slot_0_aw_0;
  component bd_2ef2_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_2ef2_slot_0_w_0;
  component bd_2ef2_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_2ef2_slot_0_b_0;
  component bd_2ef2_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_2ef2_slot_0_ar_0;
  component bd_2ef2_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_2ef2_slot_0_r_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN ILA_Interrupt_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000";
...
begin
  ...
  probe1_1(0) <= probe1(0);
  resetn_1 <= resetn;
g_inst: component bd_2ef2_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_2ef2_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
      ...
      probe3(4 downto 0) => net_slot_0_axi_araddr(4 downto 0),
      probe4(2 downto 0) => net_slot_0_axi_arprot(2 downto 0),
      probe5(1 downto 0) => net_slot_0_axi_aw_cnt(1 downto 0),
      probe6(4 downto 0) => net_slot_0_axi_awaddr(4 downto 0),
