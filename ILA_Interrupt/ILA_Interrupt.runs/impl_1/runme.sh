...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_Interrupt/ILA_Interrupt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Interrupt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ILA_Interrupt_wrapper.tcl -notrace
