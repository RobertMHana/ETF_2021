...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_Interrupt/ILA_Interrupt.runs/ILA_Interrupt_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Interrupt_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Interrupt_axi_gpio_0_0.tcl
