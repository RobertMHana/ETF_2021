...
ISEStep( "vivado",
         "-log ILA_Interrupt_InterruptGenerator_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Interrupt_InterruptGenerator_0_1.tcl" );
