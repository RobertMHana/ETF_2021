...
HD_PWD='C:/Users/Robert/xilinx_projects/VIO_Characterization/VIO_Characterization.runs/Injector_Characterization_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Injector_Characterization_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Injector_Characterization_vio_0_0.tcl
