...
(* CORE_GENERATION_INFO = "SystemILBTest,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SystemILBTest,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=2,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "SystemILBTest.hwdef" *) 
module SystemILBTest
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN SystemILBTest_sys_clock, FREQ_HZ 125000000, PHASE 0.000" *) input sys_clock;
  ...
  assign led = AXI_Sampler_0_full;
  assign reset_rtl_1 = reset_rtl;
  assign sys_clock_1 = sys_clock;
  SystemILBTest_AXI_Sampler_0_0 AXI_Sampler_0
       (.din(c_counter_binary_0_Q),
        ...
        .sync_in(util_vector_logic_0_Res),
        .sync_in_alt(util_vector_logic_0_Res),
        .wr_clk(clk_wiz_0_clk_out1),
        .wr_clk_en(clk_wiz_0_locked));
  SystemILBTest_axi_smc_0 axi_smc
  ...
  SystemILBTest_c_counter_binary_0_0 c_counter_binary_0
       (.CLK(clk_wiz_0_clk_out1),
        .Q(c_counter_binary_0_Q),
        .SCLR(util_vector_logic_0_Res));
  SystemILBTest_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        .clk_out1(clk_wiz_0_clk_out1),
        .locked(clk_wiz_0_locked),
        .reset(reset_rtl_1));
  SystemILBTest_processing_system7_0_0 processing_system7_0
  ...
  SystemILBTest_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  SystemILBTest_util_vector_logic_0_0 util_vector_logic_0
