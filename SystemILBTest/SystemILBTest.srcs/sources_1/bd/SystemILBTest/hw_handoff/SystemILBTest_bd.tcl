...
################################################################
# This is a generated script based on design: SystemILBTest
#
...
# source SystemILBTest_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {5.0} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins AXI_Sampler_0/S00_AXI] [get_bd_intf_pins axi_mem_intercon/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net AXI_Sampler_0_full [get_bd_ports led] [get_bd_pins AXI_Sampler_0/full]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins AXI_Sampler_0/din] [get_bd_pins c_counter_binary_0/Q]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXI_Sampler_0/wr_clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins AXI_Sampler_0/wr_clk_en] [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_Sampler_0/s00_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_Sampler_0/s00_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins AXI_Sampler_0/trigger] [get_bd_pins c_counter_binary_0/SCLR] [get_bd_pins util_vector_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x7AA00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_Sampler_0/S00_AXI/S00_AXI_mem] SEG_AXI_Sampler_0_S00_AXI_mem
