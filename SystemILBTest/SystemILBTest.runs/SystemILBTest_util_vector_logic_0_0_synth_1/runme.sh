...
HD_PWD='C:/Users/Robert/xilinx_projects/SystemILBTest/SystemILBTest.runs/SystemILBTest_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILBTest_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILBTest_util_vector_logic_0_0.tcl
