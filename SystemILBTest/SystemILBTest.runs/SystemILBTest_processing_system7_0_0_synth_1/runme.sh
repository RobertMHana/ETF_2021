...
HD_PWD='D:/SeaGateTransferTemp/SystemILBTest/SystemILBTest.runs/SystemILBTest_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILBTest_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILBTest_processing_system7_0_0.tcl
