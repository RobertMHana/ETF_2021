...
HD_PWD='C:/Users/Robert/xilinx_projects/SystemILBTest/SystemILBTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILBTest_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SystemILBTest_wrapper.tcl -notrace
