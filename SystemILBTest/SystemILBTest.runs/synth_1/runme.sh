...
HD_PWD='C:/Users/Robert/xilinx_projects/SystemILBTest/SystemILBTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILBTest_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILBTest_wrapper.tcl
