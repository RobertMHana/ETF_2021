...
HD_PWD='D:/SeaGateTransferTemp/SystemILBTest/SystemILBTest.runs/SystemILBTest_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILBTest_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILBTest_auto_pc_0.tcl
