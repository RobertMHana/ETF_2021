...
#
# Generated by export_simulation on Thu Jun 03 13:08:04 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './ILA_Latency.sh' script.

./ILA_Latency.sh -reset_run
...
./ILA_Latency.sh -noclean_files

For more information on the script, please type './ILA_Latency.sh -help'.
