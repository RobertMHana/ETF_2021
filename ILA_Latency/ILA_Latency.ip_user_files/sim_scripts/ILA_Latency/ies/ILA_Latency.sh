...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.ILA_Latency \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../ILA_Latency.srcs/sources_1/bd/ILA_Latency/ipshared/85a3" \
       +incdir+"../../../../ILA_Latency.srcs/sources_1/bd/ILA_Latency/ipshared/85a3" \
       +incdir+"../../../../ILA_Latency.srcs/sources_1/bd/ILA_Latency/ipshared/1b7e/hdl/verilog" \
       +incdir+"../../../../ILA_Latency.srcs/sources_1/bd/ILA_Latency/ipshared/122e/hdl/verilog" \
       +incdir+"../../../../ILA_Latency.srcs/sources_1/bd/ILA_Latency/ipshared/7d3c/hdl/verilog" \
       +incdir+"../../../../ILA_Latency.srcs/sources_1/bd/ILA_Latency/ipshared/c45e/hdl/verilog"
}
