...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_Latency/ILA_Latency.runs/ILA_Latency_pulse_rise_fall_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Latency_pulse_rise_fall_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Latency_pulse_rise_fall_0_0.tcl
