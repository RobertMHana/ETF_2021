...
HD_PWD='D:/depot/Projects/ETF_2021/ILA_Latency/ILA_Latency.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Latency_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ILA_Latency_wrapper.tcl -notrace
