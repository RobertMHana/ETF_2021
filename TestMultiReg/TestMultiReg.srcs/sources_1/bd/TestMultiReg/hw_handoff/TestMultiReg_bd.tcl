...
################################################################
# This is a generated script based on design: TestMultiReg
#
...
# source TestMultiReg_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXITrigger_0, and set properties
  set AXITrigger_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXITrigger:1.0 AXITrigger_0 ]

  # Create instance: AXI_Injector_0, and set properties
  set AXI_Injector_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_Injector:1.0 AXI_Injector_0 ]

  # Create instance: AXI_Sampler_0, and set properties
  set AXI_Sampler_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_Sampler:1.0 AXI_Sampler_0 ]
  ...
  # Create instance: InterruptGenerator_0, and set properties
  set InterruptGenerator_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:InterruptGenerator:1.0 InterruptGenerator_0 ]

  # Create instance: InterruptGenerator_1, and set properties
  set InterruptGenerator_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:InterruptGenerator:1.0 InterruptGenerator_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Timer 0#Timer 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#unassigned#unassigned} \
   CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#wave_out#clk_in#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins AXI_Injector_0/S00_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins InterruptGenerator_1/S_AXI_INTR] [get_bd_intf_pins axi_smc/M01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins AXI_Sampler_0/S00_AXI] [get_bd_intf_pins axi_smc/M02_AXI]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins InterruptGenerator_0/S_AXI_INTR] [get_bd_intf_pins axi_smc/M03_AXI]
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins ClockDivider_0/S00_AXI] [get_bd_intf_pins axi_smc/M04_AXI]
  connect_bd_intf_net -intf_net axi_smc_M05_AXI [get_bd_intf_pins AXITrigger_0/S00_AXI] [get_bd_intf_pins axi_smc/M05_AXI]
  ...
  connect_bd_net -net AXI_Injector_0_empty [get_bd_pins AXI_Injector_0/empty] [get_bd_pins InterruptGenerator_1/interrupt_in]
  connect_bd_net -net AXI_Injector_0_sync_out [get_bd_pins AXI_Injector_0/sync_out] [get_bd_pins AXI_Sampler_0/sync_in]
  connect_bd_net -net AXI_Sampler_0_full [get_bd_pins AXI_Sampler_0/full] [get_bd_pins InterruptGenerator_0/interrupt_in]
  connect_bd_net -net ClockDivider_0_clk_en_out [get_bd_pins AXI_Injector_0/rd_clk_en] [get_bd_pins AXI_Sampler_0/wr_clk_en] [get_bd_pins ClockDivider_0/clk_en_out]
  connect_bd_net -net InterruptGenerator_0_irq [get_bd_pins InterruptGenerator_0/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net InterruptGenerator_1_irq [get_bd_pins InterruptGenerator_1/irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net MUX_0_Q [get_bd_ports leds] [get_bd_pins MUX_0/Q]
  connect_bd_net -net TestMultiReg_0_dout [get_bd_pins AXI_Injector_0/dout] [get_bd_pins AXI_Sampler_0/din] [get_bd_pins MUX_0/A]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXITrigger_0/s00_axi_aclk] [get_bd_pins AXI_Injector_0/rd_clk] [get_bd_pins AXI_Injector_0/s00_axi_aclk] [get_bd_pins AXI_Sampler_0/s00_axi_aclk] [get_bd_pins AXI_Sampler_0/wr_clk] [get_bd_pins ClockDivider_0/s00_axi_aclk] [get_bd_pins InterruptGenerator_0/s_axi_intr_aclk] [get_bd_pins InterruptGenerator_1/s_axi_intr_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXITrigger_0/s00_axi_aresetn] [get_bd_pins AXI_Injector_0/s00_axi_aresetn] [get_bd_pins AXI_Sampler_0/s00_axi_aresetn] [get_bd_pins ClockDivider_0/s00_axi_aresetn] [get_bd_pins InterruptGenerator_0/s_axi_intr_aresetn] [get_bd_pins InterruptGenerator_1/s_axi_intr_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins MUX_0/sw]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x7AA30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXITrigger_0/S00_AXI/S00_AXI_mem] SEG_AXITrigger_0_S00_AXI_mem
  create_bd_addr_seg -range 0x00010000 -offset 0x7AA00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_Injector_0/S00_AXI/S00_AXI_mem] SEG_AXI_Injector_0_S00_AXI_mem
  create_bd_addr_seg -range 0x00010000 -offset 0x7AA10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_Sampler_0/S00_AXI/S00_AXI_mem] SEG_AXI_Sampler_0_S00_AXI_mem
  create_bd_addr_seg -range 0x00010000 -offset 0x7AA20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ClockDivider_0/S00_AXI/S00_AXI_mem] SEG_ClockDivider_0_S00_AXI_mem
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs InterruptGenerator_0/S_AXI_INTR/S_AXI_INTR_reg] SEG_InterruptGenerator_0_S_AXI_INTR_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs InterruptGenerator_1/S_AXI_INTR/S_AXI_INTR_reg] SEG_InterruptGenerator_1_S_AXI_INTR_reg
