...
################################################################
# This is a generated script based on design: bd_e613
#
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG001_BASE_ADDR {0x0000000043C10000} \
   ...
   CONFIG.SEG002_BASE_ADDR {0x000000007AA00000} \
   ...
   CONFIG.SEG003_BASE_ADDR {0x000000007AA10000} \
   ...
   CONFIG.SEG004_BASE_ADDR {0x000000007AA20000} \
   ...
   CONFIG.SEG005_BASE_ADDR {0x000000007AA30000} \
