...
HD_PWD='C:/Users/Robert/xilinx_projects/TestMultiReg/TestMultiReg.runs/TestMultiReg_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestMultiReg_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestMultiReg_axi_smc_0.tcl
