...
HD_PWD='D:/depot/Projects/ETF_2021/TestMultiReg/TestMultiReg.runs/TestMultiReg_AXITrigger_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestMultiReg_AXITrigger_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestMultiReg_AXITrigger_0_0.tcl
