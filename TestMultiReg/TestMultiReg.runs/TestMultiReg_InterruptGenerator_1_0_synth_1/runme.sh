...
HD_PWD='C:/Users/Robert/xilinx_projects/TestMultiReg/TestMultiReg.runs/TestMultiReg_InterruptGenerator_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestMultiReg_InterruptGenerator_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestMultiReg_InterruptGenerator_1_0.tcl
