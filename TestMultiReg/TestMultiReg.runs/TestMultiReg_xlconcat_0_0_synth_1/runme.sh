...
HD_PWD='C:/Users/Robert/xilinx_projects/TestMultiReg/TestMultiReg.runs/TestMultiReg_xlconcat_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestMultiReg_xlconcat_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestMultiReg_xlconcat_0_0.tcl
