...
HD_PWD='C:/Users/Robert/xilinx_projects/TestMultiReg/TestMultiReg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestMultiReg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestMultiReg_wrapper.tcl -notrace
