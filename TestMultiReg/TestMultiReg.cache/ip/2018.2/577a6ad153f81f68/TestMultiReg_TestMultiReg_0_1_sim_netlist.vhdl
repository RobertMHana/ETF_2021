...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TestMultiReg_v1_0_S00_AXI is
  ...
  signal \BRAM_GEN[3].BYTE_BRAM_GEN[0].ledOutput[7]_i_1_n_0\ : STD_LOGIC;
  signal \BRAM_GEN[3].BYTE_BRAM_GEN[1].ledOutput[15]_i_1_n_0\ : STD_LOGIC;
  signal \BRAM_GEN[3].BYTE_BRAM_GEN[2].ledOutput[23]_i_1_n_0\ : STD_LOGIC;
  signal \BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_arlen_cntr[7]_i_4\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[2]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[5]_i_4\ : label is "soft_lutpair9";
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].byte_ram_reg_0_15_0_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => s00_axi_wvalid,
      I2 => s00_axi_wstrb(0),
      I3 => \BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_2_n_0\,
      O => p_0_in
    );
...
\BRAM_GEN[0].BYTE_BRAM_GEN[1].byte_ram_reg_0_15_0_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
        ...
        port map (
      I0 => \BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_2_n_0\,
      I1 => s00_axi_wstrb(1),
      I2 => \^s00_axi_wready\,
      I3 => s00_axi_wvalid,
...
\BRAM_GEN[3].BYTE_BRAM_GEN[0].ledOutput[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I2 => s00_axi_wstrb(0),
      I3 => \BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_2_n_0\,
      O => \BRAM_GEN[3].BYTE_BRAM_GEN[0].ledOutput[7]_i_1_n_0\
    );
\BRAM_GEN[3].BYTE_BRAM_GEN[0].ledOutput_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \BRAM_GEN[3].BYTE_BRAM_GEN[0].ledOutput[7]_i_1_n_0\,
      D => s00_axi_wdata(0),
      Q => ledout(0),
      R => '0'
    );
...
\BRAM_GEN[3].BYTE_BRAM_GEN[1].ledOutput[15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I2 => \^s00_axi_wready\,
      I3 => s00_axi_wvalid,
      O => \BRAM_GEN[3].BYTE_BRAM_GEN[1].ledOutput[15]_i_1_n_0\
    );
\BRAM_GEN[3].BYTE_BRAM_GEN[1].ledOutput_reg[10]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \BRAM_GEN[3].BYTE_BRAM_GEN[1].ledOutput[15]_i_1_n_0\,
      D => s00_axi_wdata(10),
      Q => ledout(10),
      R => '0'
    );
...
\BRAM_GEN[3].BYTE_BRAM_GEN[2].ledOutput[23]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I2 => \^s00_axi_wready\,
      I3 => s00_axi_wvalid,
      O => \BRAM_GEN[3].BYTE_BRAM_GEN[2].ledOutput[23]_i_1_n_0\
    );
\BRAM_GEN[3].BYTE_BRAM_GEN[2].ledOutput_reg[16]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \BRAM_GEN[3].BYTE_BRAM_GEN[2].ledOutput[23]_i_1_n_0\,
      D => s00_axi_wdata(16),
      Q => ledout(16),
      R => '0'
    );
...
\BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I2 => \^s00_axi_wready\,
      I3 => s00_axi_wvalid,
      O => \BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_1_n_0\
    );
\BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput_reg[24]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \BRAM_GEN[3].BYTE_BRAM_GEN[3].ledOutput[31]_i_1_n_0\,
      D => s00_axi_wdata(24),
      Q => ledout(24),
      R => '0'
    );
