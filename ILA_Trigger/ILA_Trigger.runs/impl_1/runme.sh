...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_Trigger/ILA_Trigger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Trigger_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ILA_Trigger_wrapper.tcl -notrace
