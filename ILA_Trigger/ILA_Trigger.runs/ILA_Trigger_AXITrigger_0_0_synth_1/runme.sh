...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_Trigger/ILA_Trigger.runs/ILA_Trigger_AXITrigger_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Trigger_AXITrigger_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Trigger_AXITrigger_0_0.tcl
