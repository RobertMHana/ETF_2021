...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_Trigger/ILA_Trigger.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Trigger_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Trigger_wrapper.tcl
