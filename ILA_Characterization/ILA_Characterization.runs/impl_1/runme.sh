...
HD_PWD='D:/depot/Projects/ETF_2021/ILA_Characterization/ILA_Characterization.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Characterization_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ILA_Characterization_wrapper.tcl -notrace
