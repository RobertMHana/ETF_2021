...
HD_PWD='D:/SeaGateTransferTemp/ILA_Characterization/ILA_Characterization.runs/ILA_Characterization_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Characterization_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Characterization_clk_wiz_0_0.tcl
