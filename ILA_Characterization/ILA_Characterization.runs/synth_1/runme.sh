...
HD_PWD='D:/depot/Projects/ETF_2021/ILA_Characterization/ILA_Characterization.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_Characterization_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_Characterization_wrapper.tcl
