...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net net_slot_0_axi_arregion [get_bd_pins g_inst/m_slot_0_axi_arregion] [get_bd_pins ila_lib/probe11]
  ...
  connect_bd_net -net net_slot_0_axi_awqos [get_bd_pins g_inst/m_slot_0_axi_awqos] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net net_slot_0_axi_awready [get_bd_pins g_inst/m_slot_0_axi_awready] [get_bd_pins slot_0_aw/In1]
  connect_bd_net -net net_slot_0_axi_awregion [get_bd_pins g_inst/m_slot_0_axi_awregion] [get_bd_pins ila_lib/probe22]
  connect_bd_net -net net_slot_0_axi_awsize [get_bd_pins g_inst/m_slot_0_axi_awsize] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net net_slot_0_axi_awvalid [get_bd_pins g_inst/m_slot_0_axi_awvalid] [get_bd_pins slot_0_aw/In0]
  connect_bd_net -net net_slot_0_axi_b_cnt [get_bd_pins g_inst/m_slot_0_axi_b_cnt] [get_bd_pins ila_lib/probe24]
  connect_bd_net -net net_slot_0_axi_b_ctrl [get_bd_pins ila_lib/probe35] [get_bd_pins slot_0_b/dout]
  connect_bd_net -net net_slot_0_axi_bid [get_bd_pins g_inst/m_slot_0_axi_bid] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_0_axi_bready [get_bd_pins g_inst/m_slot_0_axi_bready] [get_bd_pins slot_0_b/In1]
  connect_bd_net -net net_slot_0_axi_bresp [get_bd_pins g_inst/m_slot_0_axi_bresp] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net net_slot_0_axi_bvalid [get_bd_pins g_inst/m_slot_0_axi_bvalid] [get_bd_pins slot_0_b/In0]
  connect_bd_net -net net_slot_0_axi_r_cnt [get_bd_pins g_inst/m_slot_0_axi_r_cnt] [get_bd_pins ila_lib/probe27]
  connect_bd_net -net net_slot_0_axi_r_ctrl [get_bd_pins ila_lib/probe37] [get_bd_pins slot_0_r/dout]
  connect_bd_net -net net_slot_0_axi_rdata [get_bd_pins g_inst/m_slot_0_axi_rdata] [get_bd_pins ila_lib/probe28]
  connect_bd_net -net net_slot_0_axi_rid [get_bd_pins g_inst/m_slot_0_axi_rid] [get_bd_pins ila_lib/probe29]
  ...
  connect_bd_net -net net_slot_0_axi_rresp [get_bd_pins g_inst/m_slot_0_axi_rresp] [get_bd_pins ila_lib/probe30]
