...
################################################################
# This is a generated script based on design: SystemILATest
#
...
# source SystemILATest_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_S00_FIFO_DEPTH {2048} \
   CONFIG.C_S00_FIFO_EMPTY_THRESH {100} \
   CONFIG.C_S00_FIFO_FULL_THRESH {1948} \
 ] $AXI_Injector_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXI_Injector_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net AXI_Injector_0_dout [get_bd_pins AXI_Injector_0/dout] [get_bd_pins util_reduced_logic_0/Op1] [get_bd_pins util_reduced_logic_1/Op1]
  connect_bd_net -net AXI_Injector_0_empty [get_bd_ports led1] [get_bd_pins AXI_Injector_0/empty] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net AXI_Injector_0_sync_out [get_bd_ports led4] [get_bd_pins AXI_Injector_0/trigger_out] [get_bd_pins system_ila_0/probe1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_Injector_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_ports led3] [get_bd_pins util_reduced_logic_0/Res]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_ports led2] [get_bd_pins util_reduced_logic_1/Res]
