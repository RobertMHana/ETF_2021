...
HD_PWD='D:/depot/Projects/ETF_2021/SystemILATest/SystemILATest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILATest_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SystemILATest_wrapper.tcl -notrace
