...
HD_PWD='D:/SeaGateTransferTemp/SystemILATest/SystemILATest.runs/SystemILATest_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILATest_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILATest_rst_ps7_0_100M_0.tcl
