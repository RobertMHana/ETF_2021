...
HD_PWD='C:/Users/Robert/xilinx_projects/SystemILATest/SystemILATest.runs/SystemILATest_util_reduced_logic_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILATest_util_reduced_logic_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILATest_util_reduced_logic_1_0.tcl
