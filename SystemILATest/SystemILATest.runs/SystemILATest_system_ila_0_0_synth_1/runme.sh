...
HD_PWD='C:/Users/Robert/xilinx_projects/SystemILATest/SystemILATest.runs/SystemILATest_system_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILATest_system_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILATest_system_ila_0_0.tcl
