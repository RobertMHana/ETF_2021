...
HD_PWD='D:/SeaGateTransferTemp/SystemILATest/SystemILATest.runs/SystemILATest_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILATest_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILATest_processing_system7_0_0.tcl
