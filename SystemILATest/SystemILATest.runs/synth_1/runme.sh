...
HD_PWD='D:/depot/Projects/ETF_2021/SystemILATest/SystemILATest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemILATest_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemILATest_wrapper.tcl
