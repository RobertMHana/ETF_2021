...
#
# Generated by export_simulation on Sun Jun 04 18:19:39 -0700 2023
#
################################################################################
...
'-reset_run' switch to the './SystemILATest.sh' script.

./SystemILATest.sh -reset_run
...
./SystemILATest.sh -noclean_files

For more information on the script, please type './SystemILATest.sh -help'.
