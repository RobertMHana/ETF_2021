...
proc update_PARAM_VALUE.C_S00_FIFO_EMPTY_THRESH { PARAM_VALUE.C_S00_FIFO_EMPTY_THRESH } {
	# Procedure called to update C_S00_FIFO_EMPTY_THRESH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_FIFO_EMPTY_THRESH { PARAM_VALUE.C_S00_FIFO_EMPTY_THRESH } {
	# Procedure called to validate C_S00_FIFO_EMPTY_THRESH
	return true
}

proc update_PARAM_VALUE.C_S00_FIFO_FULL_THRESH { PARAM_VALUE.C_S00_FIFO_FULL_THRESH } {
	# Procedure called to update C_S00_FIFO_FULL_THRESH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_FIFO_FULL_THRESH { PARAM_VALUE.C_S00_FIFO_FULL_THRESH } {
	# Procedure called to validate C_S00_FIFO_FULL_THRESH
	return true
}
...
proc update_MODELPARAM_VALUE.C_S00_FIFO_FULL_THRESH { MODELPARAM_VALUE.C_S00_FIFO_FULL_THRESH PARAM_VALUE.C_S00_FIFO_FULL_THRESH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_FIFO_FULL_THRESH}] ${MODELPARAM_VALUE.C_S00_FIFO_FULL_THRESH}
}

proc update_MODELPARAM_VALUE.C_S00_FIFO_EMPTY_THRESH { MODELPARAM_VALUE.C_S00_FIFO_EMPTY_THRESH PARAM_VALUE.C_S00_FIFO_EMPTY_THRESH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_FIFO_EMPTY_THRESH}] ${MODELPARAM_VALUE.C_S00_FIFO_EMPTY_THRESH}
}
