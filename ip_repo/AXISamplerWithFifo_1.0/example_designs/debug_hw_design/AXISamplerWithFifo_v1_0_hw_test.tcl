# Runtime Tcl commands to interact with - AXISamplerWithFifo_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/AXISamplerWithFifo_v1_0_include.tcl
...
# Test: S00_AXI_SamplerFIFO
# Create a burst write transaction at s00_axi_samplerfifo_addr address
create_hw_axi_txn w_s00_axi_samplerfifo_addr [get_hw_axis $jtag_axi_master] -type write -address $s00_axi_samplerfifo_addr -len 4 -data $wdata_2 -burst INCR
# Create a burst read transaction at s00_axi_samplerfifo_addr address
create_hw_axi_txn r_s00_axi_samplerfifo_addr [get_hw_axis $jtag_axi_master] -type read -address $s00_axi_samplerfifo_addr -len 4 -burst INCR
# Initiate transactions
run_hw_axi r_s00_axi_samplerfifo_addr
run_hw_axi w_s00_axi_samplerfifo_addr
run_hw_axi r_s00_axi_samplerfifo_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s00_axi_samplerfifo_addr]]
# Compare read data
if { $rdata_tmp == $wdata_2 } {
	puts "Data comparison test pass for - S00_AXI_SamplerFIFO"
} else {
	puts "Data comparison test fail for - S00_AXI_SamplerFIFO, expected-$wdata_2 actual-$rdata_tmp"
	inc ec
}
