...
HD_PWD='D:/depot/Projects/ETF_2021/VIO_Latency/VIO_Latency.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_Latency_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VIO_Latency_wrapper.tcl -notrace
