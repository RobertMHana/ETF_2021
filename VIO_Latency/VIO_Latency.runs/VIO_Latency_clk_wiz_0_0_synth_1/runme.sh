...
HD_PWD='D:/SeaGateTransferTemp/VIO_Latency/VIO_Latency.runs/VIO_Latency_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_Latency_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VIO_Latency_clk_wiz_0_0.tcl
