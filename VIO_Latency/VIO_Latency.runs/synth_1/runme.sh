...
HD_PWD='D:/depot/Projects/ETF_2021/VIO_Latency/VIO_Latency.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VIO_Latency_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VIO_Latency_wrapper.tcl
