...
#
# Generated by export_simulation on Thu Jun 03 13:23:02 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './VIO_Latency.sh' script.

./VIO_Latency.sh -reset_run
...
./VIO_Latency.sh -noclean_files

For more information on the script, please type './VIO_Latency.sh -help'.
