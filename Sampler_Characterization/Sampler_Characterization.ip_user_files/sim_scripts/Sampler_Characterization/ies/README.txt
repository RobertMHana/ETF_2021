...
#
# Generated by export_simulation on Wed May 26 21:24:07 -0700 2021
#
################################################################################
...
'-reset_run' switch to the './Sampler_Characterization.sh' script.

./Sampler_Characterization.sh -reset_run
...
./Sampler_Characterization.sh -noclean_files

For more information on the script, please type './Sampler_Characterization.sh -help'.
