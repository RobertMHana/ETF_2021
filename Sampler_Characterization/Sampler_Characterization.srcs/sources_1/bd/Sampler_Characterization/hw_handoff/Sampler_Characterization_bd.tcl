...
################################################################
# This is a generated script based on design: Sampler_Characterization
#
...
# source Sampler_Characterization_script.tcl
...
set design_name Sampler_Characterization
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_S00_FIFO_DEPTH {16384} \
   CONFIG.C_S00_FIFO_PROG_FULL_THRESH {16381} \
 ] $AXI_Sampler_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins AXI_Sampler_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins AXITrigger_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net AXITrigger_0_trigger_output [get_bd_pins AXITrigger_0/trigger_output] [get_bd_pins AXI_Sampler_0/trigger]
  connect_bd_net -net AXI_Sampler_0_full [get_bd_pins AXI_Sampler_0/full] [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins AXITrigger_0/trigger_input] [get_bd_pins AXI_Sampler_0/din] [get_bd_pins c_counter_binary_0/Q]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins AXITrigger_0/clock] [get_bd_pins AXI_Sampler_0/wr_clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins AXITrigger_0/clock_en] [get_bd_pins AXI_Sampler_0/wr_clk_en] [get_bd_pins c_counter_binary_0/CE] [get_bd_pins clk_wiz_0/locked] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXITrigger_0/s00_axi_aclk] [get_bd_pins AXI_Sampler_0/s00_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXITrigger_0/s00_axi_aresetn] [get_bd_pins AXI_Sampler_0/s00_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x7AA00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXITrigger_0/S00_AXI/S00_AXI_mem] SEG_AXITrigger_0_S00_AXI_mem
