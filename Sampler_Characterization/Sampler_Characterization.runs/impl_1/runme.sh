...
HD_PWD='D:/depot/Projects/ETF_2021/Sampler_Characterization/Sampler_Characterization.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler_Characterization_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sampler_Characterization_wrapper.tcl -notrace
