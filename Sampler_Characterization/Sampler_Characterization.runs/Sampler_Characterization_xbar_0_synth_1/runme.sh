...
HD_PWD='C:/Users/Robert/xilinx_projects/Sampler_Characterization/Sampler_Characterization.runs/Sampler_Characterization_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler_Characterization_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sampler_Characterization_xbar_0.tcl
