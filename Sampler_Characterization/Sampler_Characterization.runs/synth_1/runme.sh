...
HD_PWD='D:/depot/Projects/ETF_2021/Sampler_Characterization/Sampler_Characterization.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler_Characterization_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sampler_Characterization_wrapper.tcl
