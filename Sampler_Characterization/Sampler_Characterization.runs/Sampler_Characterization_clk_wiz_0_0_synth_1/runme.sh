...
HD_PWD='D:/SeaGateTransferTemp/Sampler_Characterization/Sampler_Characterization.runs/Sampler_Characterization_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler_Characterization_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sampler_Characterization_clk_wiz_0_0.tcl
