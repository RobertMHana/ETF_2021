...
synth_design -top ILA_ClockDivider_wrapper -part xc7z010clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef ILA_ClockDivider_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file ILA_ClockDivider_wrapper_utilization_synth.rpt -pb ILA_ClockDivider_wrapper_utilization_synth.pb"
