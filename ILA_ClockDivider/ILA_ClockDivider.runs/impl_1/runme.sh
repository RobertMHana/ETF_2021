...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_ClockDivider/ILA_ClockDivider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_ClockDivider_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ILA_ClockDivider_wrapper.tcl -notrace
