...
HD_PWD='C:/Users/Robert/xilinx_projects/ILA_ClockDivider/ILA_ClockDivider.runs/ILA_ClockDivider_ClockDivider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_ClockDivider_ClockDivider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_ClockDivider_ClockDivider_0_0.tcl
