...
#
# Generated by export_simulation on Sun Jun 04 17:39:36 -0700 2023
#
################################################################################
...
'-reset_run' switch to the './ILA_ClockDivider.sh' script.

./ILA_ClockDivider.sh -reset_run
...
./ILA_ClockDivider.sh -noclean_files

For more information on the script, please type './ILA_ClockDivider.sh -help'.
