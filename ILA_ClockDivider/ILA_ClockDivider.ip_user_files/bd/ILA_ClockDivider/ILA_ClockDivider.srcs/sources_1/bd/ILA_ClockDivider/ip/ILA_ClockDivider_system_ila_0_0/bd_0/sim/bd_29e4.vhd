...
----------------------------------------------------------------------------------
--Command: generate_target bd_29e4.bd
--Design : bd_29e4
...
entity bd_29e4 is
  ...
  attribute CORE_GENERATION_INFO of bd_29e4 : entity is "bd_29e4,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_29e4,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_29e4 : entity is "ILA_ClockDivider_system_ila_0_0.hwdef";
end bd_29e4;

architecture STRUCTURE of bd_29e4 is
  component bd_29e4_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_29e4_ila_lib_0;
  component bd_29e4_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_29e4_g_inst_0;
  component bd_29e4_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29e4_slot_0_aw_0;
  component bd_29e4_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_29e4_slot_0_w_0;
  component bd_29e4_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29e4_slot_0_b_0;
  component bd_29e4_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29e4_slot_0_ar_0;
  component bd_29e4_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In2 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_29e4_slot_0_r_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN ILA_ClockDivider_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000";
  ...
  attribute X_INTERFACE_PARAMETER of SLOT_0_AXI_araddr : signal is "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 6, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN ILA_ClockDivider_processing_system7_0_0_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, MAX_BURST_LENGTH 16, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0";
...
begin
  ...
  probe0_1(0) <= probe0(0);
  resetn_1 <= resetn;
g_inst: component bd_29e4_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_29e4_ila_lib_0
     port map (
      ...
      probe18(2 downto 0) => net_slot_0_axi_awsize(2 downto 0),
      probe19(1 downto 0) => net_slot_0_axi_b_cnt(1 downto 0),
      probe2(5 downto 0) => net_slot_0_axi_araddr(5 downto 0),
      ...
      probe23(1 downto 0) => net_slot_0_axi_rresp(1 downto 0),
      probe24(31 downto 0) => net_slot_0_axi_wdata(31 downto 0),
      probe25(3 downto 0) => net_slot_0_axi_wstrb(3 downto 0),
...
slot_0_w: component bd_29e4_slot_0_w_0
     port map (
